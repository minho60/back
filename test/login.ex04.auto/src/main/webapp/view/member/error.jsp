...
<div id="error">
	<div>
		<img src="${pageContext.request.contextPath}/static/assets/img/dodram.svg" alt="logo">
		<c:choose>
	        <%-- 404 에러일 경우 --%>
	...
	<div>
		<img src="${pageContext.request.contextPath}/static/assets/img/monkey.jpg" alt="error">
	</div>
