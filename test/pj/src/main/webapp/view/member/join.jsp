...
<%@ include file="/view/common/header.jsp" %>
	<section>
		...
		<p>회원정보를 입력해주세요.</p>
		<form name="regFrm" method="post" action="${pageContext.request.contextPath}/join">
			<table class="form-table">
				...
				<tr>
					...
					<td><%-- 같은 name을 가진 그룹 내의 요소 중 하나에만 required를 추가하면 그룹 전체에 적용됩니다. 
						...
						<label><input type="radio" name="gender" value="M" checked required> 남</label>
				...
				<tr>
					...
					<td>
						...
						<button type="button" onclick="idCheck(this.form.id.value)">ID 중복확인</button>
